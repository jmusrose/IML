...
from ablation_fgm import add_fgm_arguments
from datasets import KSDataset, KSTrainImageTransform, ResizeToTensorNormalize, discover_ks_samples, load_ks_classes
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    add_fgm_arguments(parser, warmup_default=15)
